...
class CertificadoIngresoController extends Controller
{
    ...
    public function CertificadoAction(Request $request, $codigoEmpleado) {
        ...
        $formCertificado = $this->createFormBuilder()
            ...
            ->add('certifico1', TextType::class, array('data' => '1. Mi patrimonio bruto era igual o inferior a 4.500 UVT ($171.018.000)', 'required' => true))
            ->add('certifico2', TextType::class, array('data' => '2. No fui responsable del impuesto sobre las ventas a 31 de Diciembre del 2022.', 'required' => true))
            ->add('certifico3', TextType::class, array('data' => '3. Mis ingresos totales fueron iguales o inferiores a 1.400 UVT ($53.206.000).', 'required' => true))
            ->add('certifico4', TextType::class, array('data' => '4. Mis consumos mediante tarjeta de crédito no excedieron la suma de 1.400 UVT ($53.206.000).', 'required' => true))
            ->add('certifico5', TextType::class, array('data' => '5. Que el total de mis compras y consumos no superaron la suma de 1.400 UVT ($53.206.000).', 'required' => true))
            ->add('certifico6', TextType::class, array('data' => '6. Que el valor total de mis consignaciones bancarias, depósitos o inversiones financieras no excedieron la suma de 1.400 UVT ($53.206.000).', 'required' => true))
